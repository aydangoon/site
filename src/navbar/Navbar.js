                    ...
                    <button className="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div className="dropdown-menu theme" aria-labelledby="dropdownMenuButton">
                            <div className = 'dropdown-item'>
                                <a href='https://www.github.com/aydangoon' target='_blank' rel="noopener noreferrer">
                                    <img className='icon' src={require('../assets/git.png')} alt=''/>
                                </a>
                            </div>
                            <div className = 'dropdown-item'>
                                <a href='https://www.linkedin.com/in/aydan-gooneratne-118b49178/' target='_blank' rel="noopener noreferrer">
...
function modeIcon(dark) {
    const moon = (
        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-moon" fill="white" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" d="M14.53 10.53a7 7 0 0 1-9.058-9.058A7.003 7.003 0 0 0 8 15a7.002 7.002 0 0 0 6.53-4.47z"/>
        </svg>
    )
    const sun = (<svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-brightness-high" fill="black" xmlns="http://www.w3.org/2000/svg">
